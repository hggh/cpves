...
my $sth = $dbh->prepare("SELECT a.server,a.proto,a.conn_type,a.username,a.password,a.keep_mails,b.email FROM fetchmail AS a LEFT JOIN users AS b ON b.id=a.email");
$sth->execute;
my $row;
my $fetchmail="";
